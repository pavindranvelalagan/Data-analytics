...
<div class="topnav" id="myTopnav">
  ...
  <a href="6.php">Pie</a>
  <a href="7.php" class="active">Doughnut</a>
...
<div class="container">
 <center><h2>Doughnut chart</h2></center>
</div>
...
&nbsp;
&nbsp; Enter the value :
      <input id="yValue" type="number" step="any" placeholder="Enter the values one by one" min="0" required="" />
