...
<div class="topnav" id="myTopnav">
  ...
  <a href="1.php">Line</a>
  <a href="2.php" class="active">Column</a>
  <a href="3.php">Bar</a>
  <a href="4.php">Area</a>
...
<div class="container">
 <center><h2>Column chart</h2></center>
</div>
...
h2:before{
 ...
 <script type="text/javascript">
      ...
      <input id="xValue" type="number" step="any" placeholder="Interval between columns" min="0" required="">
      Y Value:
      <input id="yValue" type="number" step="any" placeholder="Enter Y-Value" min="0" required="">
